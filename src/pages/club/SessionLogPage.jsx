...
import { resolvePeriods } from '../../engine/forecast'
              ...
              <li key={date} className={cx(
                ...
                {isEditing ? (
                  ...
                  <div className="flex items-center gap-3">
                    <span className={cx('grid h-9 w-9 shrink-0 place-items-center rounded-xl text-sm', isActual ? 'bg-slate-100 text-slate-500' : 'bg-slate-100 text-slate-300')}>
